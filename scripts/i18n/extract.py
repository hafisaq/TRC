...
UI = [
    ...
    ("more.label", "Selectors — trailing More item", "More"),
    ("more.eyebrow", "Selectors — trailing More item", "Somewhere else in mind?"),
    ("more.copy", "Selectors — trailing More item", "Tell us where you want to go — the route is arranged around you, not a list."),
    ("more.cta", "Selectors — trailing More item", "Ask us →"),
